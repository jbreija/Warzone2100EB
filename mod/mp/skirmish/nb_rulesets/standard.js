...
const structures = {
	factories: [ "A0LightFactory", "A0RoboticFactory", "A0LargeFactory1"],
	templateFactories: [ "A0CyborgFactory", "A0CyborgFactoryMech"],
	vtolFactories: [ "A0VTolFactory1", "A0LargeVTolFactory1"],
	labs: [ "A0ResearchFacility", "A0DedicatedResearchFacility"],
	gens: [ "A0PowerGenerator", "A0VapPowerGenerator"],
	hqs: [ "A0CommandCentre", "A0CommandCentreAR"],
	vtolPads: [ "A0VtolPad", ],
	derricks: [ "A0ResourceExtractor", "A0ResourceExtractorMG"],
	extras: [ "A0RepairCentre3", "A0Sat-linkCentre", "A0LasSatCommand", "A0RepairCentre2", "A0RepairCentre4"],
...
const bodyStats = [
	...
	{ res: "R-Vehicle-Body20", stat: "Body20LGT", weight: WEIGHT.LIGHT, usage: BODYUSAGE.UNIVERSAL, armor: BODYCLASS.KINETIC }, // viper hardened alloys
	{ res: "R-Vehicle-Body26", stat: "Body11REC", weight: WEIGHT.LIGHT, usage: BODYUSAGE.COMBAT, armor: BODYCLASS.KINETIC }, // NASDA viper
	{ res: "R-Vehicle-Body08", stat: "Body88MBT", weight: WEIGHT.MEDIUM, usage: BODYUSAGE.COMBAT, armor: BODYCLASS.THERMAL }, // NASDA scorpion
	{ res: "R-Vehicle-Body18", stat: "Body18MED", weight: WEIGHT.MEDIUM, usage: BODYUSAGE.COMBAT, armor: BODYCLASS.THERMAL }, // Scorpion Thermal alloys
	{ res: "R-Vehicle-Body21", stat: "Body21MED", weight: WEIGHT.MEDIUM, usage: BODYUSAGE.COMBAT, armor: BODYCLASS.KINETIC }, // Cobra Hardened alloys
	{ res: "R-Vehicle-Body22", stat: "Body22HVY", weight: WEIGHT.HEAVY, usage: BODYUSAGE.GROUND, armor: BODYCLASS.KINETIC }, // Python Hardened allys
	{ res: "R-Vehicle-Body21", stat: "Body27SUP", weight: WEIGHT.HEAVY, usage: BODYUSAGE.GROUND, armor: BODYCLASS.KINETIC }, // Super Heavy Hardened Python
	{ res: "R-Vehicle-Body15", stat: "Body15LGT", weight: WEIGHT.LIGHT, usage: BODYUSAGE.UNIVERSAL, armor: BODYCLASS.THERMAL }, // Superior alloys leopard
	{ res: "R-Vehicle-Body16", stat: "Body16MED", weight: WEIGHT.MEDIUM, usage: BODYUSAGE.UNIVERSAL, armor: BODYCLASS.THERMAL }, // Superior alloys panther
	{ res: "R-Vehicle-Body07", stat: "Body28SUP", weight: WEIGHT.HEAVY, usage: BODYUSAGE.GROUND, armor: BODYCLASS.THERMAL }, // Super Heavy retribution
	{ res: "R-Vehicle-Body19", stat: "Body26SUP", weight: WEIGHT.HEAVY, usage: BODYUSAGE.GROUND, armor: BODYCLASS.THERMAL }, // Super Heavy Thermal mantis
	{ res: "R-Vehicle-Body02", stat: "Body25SUP", weight: WEIGHT.HEAVY, usage: BODYUSAGE.GROUND, armor: BODYCLASS.KINETIC }, // Super Heavy Leopard
	{ res: "R-Vehicle-Body12", stat: "Body24SUP", weight: WEIGHT.HEAVY, usage: BODYUSAGE.GROUND, armor: BODYCLASS.THERMAL }, // Super Heavy mantis
	{ res: "R-Vehicle-Body11", stat: "Body23SUP", weight: WEIGHT.HEAVY, usage: BODYUSAGE.GROUND, armor: BODYCLASS.KINETIC }, // Super Heavy python
];
...
const propulsionStats = [
	...
	{ res: "R-Vehicle-Prop-Wheels", stat: "wheeled01NAS", usage: PROPULSIONUSAGE.GROUND },
...
const truckTurrets = [
	"Spade1Mk1", "Spade1Mk1NAS", "Spade1Hvy"
];

const truckTemplates = [
	{ body: "CyborgLightBody", prop: "CyborgLegs", weapons: [ "CyborgSpade", ] },
	{ body: "CyborgLightBody", prop: "CyborgLegs", weapons: [ "CyborgSpade", ] },
	{ body: "Body1REC", prop: "wheeled01", weapons: [ "Spade1Mk1", ] },
	{ body: "Body5REC", prop: "hover01", weapons: [ "Spade1Mk1", ] },
	{ body: "Body5REC", prop: "tracked01", weapons: [ "Spade1Mk1", ] },
	{ body: "Body1REC", prop: "wheeled01", weapons: [ "Spade1Mk1", ] },
	{ body: "Body11REC", prop: "wheeled01NAS", weapons: [ "Spade1Mk1NAS", ] },
	{ body: "Body12SUP", prop: "hover01", weapons: [ "Spade1Mk1", ] },
	{ body: "Body8MBT", prop: "hover01", weapons: [ "Spade1Mk1", ] },
	{ body: "Body4ABT", prop: "hover01", weapons: [ "Spade1Mk1", ] },
	{ body: "Body17LGT", prop: "hover01", weapons: [ "Spade1Mk1", ] },
	{ body: "Body18MED", prop: "hover01", weapons: [ "Spade1Mk1", ] },
	{ body: "Body19HVY", prop: "hover01", weapons: [ "Spade1Mk1", ] },
	{ body: "Body21MED", prop: "hover01", weapons: [ "Spade1Mk1", ] },
	{ body: "CyborgLightNAS", prop: "CyborgLegsNAS", weapons: [ "CyborgSpade", ] },
