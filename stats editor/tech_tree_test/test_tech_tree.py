...
def calculate_upgrades():
    ...
    for x in range(1, 10):
        ...
        if x == 1:
            ...
            num_sec = (JSON_DATA[upgrade_name]["researchPoints"] / UPGRADE_DICT[RES_MOD]['upgrade']) + UPGRADE_DICT[RES_MOD]['seconds']
            ...
            num_sec = (JSON_DATA[upgrade_name]["researchPoints"]/UPGRADE_DICT[f"{upgrade_string}{x - 1}"]['upgrade'])+UPGRADE_DICT[f"{upgrade_string}{x - 1}"]['seconds']
            UPGRADE_DICT[upgrade_name] = {"points": num_points,
                                          "upgrade": upgrade,
                                          "seconds": num_sec
                                          }
...
def apply_upgrades():
    ...
    for key, value in FINISHED_RESEARCH.items():
        if FINISHED_RESEARCH[key] < UPGRADE_DICT[RES_MOD]['points']:
            ...
            total_seconds = ((FINISHED_RESEARCH[key] - UPGRADE_DICT[res1]['points']) / UPGRADE_DICT[res1]['upgrade']) + UPGRADE_DICT[res1]["seconds"]
            ...
            total_seconds = ((FINISHED_RESEARCH[key] - UPGRADE_DICT[res2]['points']) / UPGRADE_DICT[res2]['upgrade']) + UPGRADE_DICT[res2]["seconds"]
            ...
            total_seconds = ((FINISHED_RESEARCH[key] - UPGRADE_DICT[res3]['points']) / UPGRADE_DICT[res3]['upgrade']) + UPGRADE_DICT[res3]["seconds"]
            ...
            total_seconds = ((FINISHED_RESEARCH[key] - UPGRADE_DICT[res4]['points']) / UPGRADE_DICT[res4]['upgrade']) + UPGRADE_DICT[res4]["seconds"]
            ...
            total_seconds = ((FINISHED_RESEARCH[key] - UPGRADE_DICT[res5]['points']) / UPGRADE_DICT[res5]['upgrade']) + UPGRADE_DICT[res5]["seconds"]
            ...
            total_seconds = ((FINISHED_RESEARCH[key] - UPGRADE_DICT[res6]['points']) / UPGRADE_DICT[res6]['upgrade']) + UPGRADE_DICT[res6]["seconds"]
            ...
            total_seconds = ((FINISHED_RESEARCH[key] - UPGRADE_DICT[res7]['points']) / UPGRADE_DICT[res7]['upgrade']) + UPGRADE_DICT[res7]["seconds"]
            ...
            total_seconds = ((FINISHED_RESEARCH[key] - UPGRADE_DICT[res8]['points']) / UPGRADE_DICT[res8]['upgrade']) + UPGRADE_DICT[res8]["seconds"]
        elif UPGRADE_DICT[res9]['points'] < FINISHED_RESEARCH[key]:
            num_seconds = JSON_DATA[key]['researchPoints'] / UPGRADE_DICT[res9]['upgrade']
            total_seconds = ((FINISHED_RESEARCH[key] - UPGRADE_DICT[res9]['points']) / UPGRADE_DICT[res9]['upgrade']) + UPGRADE_DICT[res9]["seconds"]
